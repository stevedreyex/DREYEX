#execute: python3 -m unittest -v PyIntro_CH4.py
import unittest
import math
import copy
...
class TestFunction(unittest.TestCase):
    ...
    def test_collections_abc(self):
        ...
        #Mutablesequence為可變形別，包含remove, append....
        self.assertEqual(a, True)
...
#---------------------------------以下是slicing---------------------------------        
    ...
    def test_slicing(self):
        ...
        # 倒轉取值，三個值的slicing: [頭:尾:間隔(default = 1)]
        u, *v = ls[1::2]
    ...
    def test_slicing_assignment(self):
       ls = [30, 41, 52, 63, 74, 85] 
       ls[0:2] = 'a', 'b'
       self.assertEqual(ls,  ['a','b' , 52, 63, 74, 85])
       #你可以指派一個slicing, 但他必須是一個Iterator
